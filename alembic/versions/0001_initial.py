"""initial schema: users, conversations, messages, token_usage

建立项目初始表结构。后续改表结构请新增迁移，不要再依赖 create_all。
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_token_usage_conversation_id", "token_usage", ["conversation_id"], unique=False
    )
